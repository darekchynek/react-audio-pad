...
var AudioPad = function (_React$Component) {
  _inherits(AudioPad, _React$Component);

  function AudioPad(props) {
    _classCallCheck(this, AudioPad);

    var _this = _possibleConstructorReturn(this, (AudioPad.__proto__ || Object.getPrototypeOf(AudioPad)).call(this, props));
    ...
    _this.audio.setAttribute("crossorigin", "anonymous");
  ...
  _createClass(AudioPad, [{
    ...
    key: "createListener",
    value: function createListener(audio, keyCode, keyUp) {
      var _this2 = this;
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { style: this.audioBlock },
        _react2.default.createElement("div", {
          style: this.state.hover === true ? this.hoverStyle : this.defaultStyle
        }),
...
AudioPad.propTypes = {
  ...
  audioUrl: _propTypes2.default.string,
  color: _propTypes2.default.string,
  keyCode: _propTypes2.default.string,
  keyUp: _propTypes2.default.bool
};
